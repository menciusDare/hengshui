        ...
        <div v-show="show1">
          ...
          <div class="companyForm">
            ...
            <el-form-item label="行业类别与代码：" prop="categoryId">
              ...
              ></el-input> -->
              <div class="block">
                <el-cascader v-model="companylist.categoryId" @change="handleChange1" :options="categoryOptions" :props="{ value: 'industryId', label: 'industryName' }" emitPath :disabled="disabled"></el-cascader>
              </div>
            </el-form-item>
...
export default {
  ...
  methods: {
    ...
    getCategoryOptions() {
      let self = this;
      self.$axios
        .get("/api/regulatory/tIndustryCategory/getIndustryTree")
        .then((res) => {
